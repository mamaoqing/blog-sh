            ...
            <li class="list-group-item">
                <div class="text-center">
                    <a class="btn btn-default btn-sm" href="javascript:void(0);" data-id="${view.id}" rel="favor">
                        <i class="icon icon-star"></i> 点赞 <strong id="favors">${view.favors}</strong>
                    </a>
                </div>
            </li>
        </ul>
        <!-- 热门文章 -->
        <div class="panel panel-default widget top">
...
<script type="text/javascript">
    ...
    <script src="${base}/theme/concise/dist/js/viewer-unit.js"></script>
</@layout>
