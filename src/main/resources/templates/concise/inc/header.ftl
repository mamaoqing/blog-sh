        ...
        <nav class="navbar" role="navigation">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="${base}/"><i class="fa fa-home tags-i"></i>首页</a>
                    </li>
					<#if profile??>
						<li data="user">
                        ...
                        <li>
                            <a href="${base}/tags" nav="tags"><i class="fa fa-tag tags-i"></i>标签</a>
                        </li>
                </ul>
...
<!-- 二级导航 start -->
<div class="headGroup white fixed hidden-xs hidden-sm" id="headGroup">
