    ...
    <#if row.thumbnail?? && row.thumbnail?length gt 0>
        <div class="content-box">
            ...
            <div class="posts-item posts-item-gallery">
                <h2><span class="ico-cat"><@utils.showChannel row/></span><a href="${base}/post/${row.id}"><#if escape>${row.title?html}<#else>${row.title}</#if></a></h2>
                ...
                <div class="item-info">
                    <ul>
                        ...
                        <li class="ico-eye"><i class="icon-book-open"></i>${row.views}</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="content-box posts-aside">
            <div class="posts-item">
                <div class="item-title">
                    <h2><span class="ico-cat hidden-xs"><@utils.showChannel row/></span><a href="${base}/post/${row.id}"><#if escape>${row.title?html}<#else>${row.title}</#if></a></h2>
                </div>
